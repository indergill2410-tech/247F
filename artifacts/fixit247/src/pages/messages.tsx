            ...
            {conversations.map((convo, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-[#130f07] border border-white/6 rounded-2xl p-4 cursor-pointer hover:border-primary/25 hover:bg-[#1a1508] transition-all group"
                >
                  <div className="flex items-center gap-4">
                    {/* Avatar */}
                    <div className="relative flex-shrink-0">
                      <div className="w-12 h-12 rounded-xl bg-primary text-primary-foreground font-black text-lg flex items-center justify-center">
                        {otherInitial}
                      </div>
                      {hasUnread && (
                        <span className="absolute -top-1 -right-1 w-4 h-4 bg-primary rounded-full border-2 border-[#0b0904]" />
                      )}
                    </div>
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      {hasUnread && (
                        <span className="min-w-[20px] h-5 bg-primary text-primary-foreground text-[10px] font-black rounded-full flex items-center justify-center px-1">
