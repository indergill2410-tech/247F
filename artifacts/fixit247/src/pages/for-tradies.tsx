          ...
          <div className="flex flex-col lg:flex-row items-center gap-14">
            ...
            >
              ...
              <p className="text-lg text-white/60 max-w-md leading-relaxed mb-8">
                Get <span className="text-white font-semibold">1,111 free credits every month</span> to unlock local jobs and start winning new work through Fixit 24/7. Stop relying only on expensive ads or unpredictable referrals — use your monthly credits to get in front of homeowners already looking for help.
              </p>
