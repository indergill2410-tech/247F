    ...
    <div className="min-h-screen bg-[#0b0904] flex flex-col">
      ...
      <div className="border-b border-white/6 bg-[#0f0c06] px-4 py-4 flex-shrink-0">
        <div className="container max-w-2xl flex items-center gap-3">
          ...
          <div className="w-9 h-9 rounded-xl bg-primary text-primary-foreground font-black text-base flex items-center justify-center flex-shrink-0">
      ...
      <div className="border-t border-white/6 bg-[#0f0c06] px-4 py-4 flex-shrink-0">
        <div className="container max-w-2xl flex gap-3 items-end">
          <textarea
            ...
            rows={1}
            className="flex-1 bg-white/6 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-primary/50 transition-all resize-none max-h-32"
            style={{ scrollbarWidth: "none" }}
          />
          <button
            onClick={handleSend}
            disabled={!body.trim() || sendMutation.isPending}
            className="h-11 w-11 rounded-xl bg-primary hover:opacity-90 text-primary-foreground flex items-center justify-center flex-shrink-0 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
          >
