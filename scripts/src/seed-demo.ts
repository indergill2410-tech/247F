...
async function seed() {
  ...
  // Add ABN + licence numbers so demo tradies can claim licensed trades
  await query(`UPDATE users SET abn = '12 345 678 901', licence_number = 'NSW-PL-001234' WHERE id = $1`, [t1]);
  await query(`UPDATE users SET abn = '23 456 789 012', licence_number = 'NSW-EC-002345' WHERE id = $1`, [t2]);
  await query(`UPDATE users SET abn = '34 567 890 123' WHERE id = $1`, [t3]);
  await query(`UPDATE users SET abn = '45 678 901 234' WHERE id = $1`, [t4]);
  await query(`UPDATE users SET abn = '56 789 012 345', licence_number = 'NSW-RA-003456' WHERE id = $1`, [t5]);
